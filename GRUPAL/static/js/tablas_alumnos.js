...
xhr.onload = function () {
  ...
  if (this.status === 200) {
    ...
    alumnos.forEach(function (alumno) {
      tablaHtml += `<tr>
                            <td class="editable">${alumno.nombre}</td>
                            <td class="editable">${alumno.apellido}</td>
                            <td class="editable">${alumno.dni}</td>
                            <td class="editable">${alumno.empresa}</td>
                            <td class="editable">${alumno.correo}</td>
                            <td class="editable"><a href="tareas_alumnos.html?nombre=${alumno.nombre}&apellido=${alumno.apellido}">
    ...
    const tablaAlumnos = document.querySelector('#tabla_alumnos');
    tablaAlumnos.style.border = "solid 1px black";
...
//Función que agrega una nueva fila a la tabla de alumnos.
function agregarFila() {
  ...
  nuevaFila.innerHTML = `<td>${alumno.nombre}</td>
                        ...
                        <td class="editable">${alumno.correo}</td>
                        <td class="editable">
                        <button type="button" class="ver btn btn-info">Ficha</button><button type="button" class="borrar btn btn-danger" style="margin-left: 9%;">Borrar</button></td>`;
  ...
  if (storedAlumnos) {
    ...
    alumnos.forEach(function (alumno) {
      ...
      nuevaFila.innerHTML = `<td>${alumno.nombre}</td>
                              ...
                              <td class="editable">${alumno.empresa}</td>
                              <td class="editable">${alumno.correo}</td>
                              <td class="editable"><button type="button" class="ver btn btn-info">Ficha</button><button type="button" class="borrar btn btn-danger" style="margin-left: 9%;">Borrar</button></td>`;
      tbody.appendChild(nuevaFila);
    });
  }
...
empresallamada.onload = function () {
  ...
  if (this.status === 200) {
    ...
    emparray.forEach(function (empresa) {
      tablaHtml += `<tr>
                            <td class="editable">${empresa.nombreEmpresa}</td>
                            <td class="editable">${empresa.telefonoEmpresa}</td>
                            <td class="editable">${empresa.mailEmpresa}</td>
                            <td class="editable">${empresa.responsableEmpresa}</td>
                            <td class="editable" style="border: 1px solid black;"><button type="button" class="borrar btn btn-danger" style="margin-left: 9%;">Borrar</button></td>
                            </tr>`;
    });
...
function agregarEmpresa() {
  ...
  <td class="editable">${empresa.nombre}</td>
  <td class="editable">${empresa.telefono}</td>
  <td class="editable">${empresa.email}</td>
  <td class="editable">${empresa.responsable}</td>
  <td class="editable"><button type="button" class="borrar btn btn-danger" style="margin-left: 9%;">Borrar</button></td>
